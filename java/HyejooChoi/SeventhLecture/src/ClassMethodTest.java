class Teacher {
    ...
    // 회원가입시 집 주소 적으라고 나오는데 여기서 입력하는 값들을 처리하는게 Setter에 해당
    // 특정한 값을 설정하는 목적으로 Setter 가 사용된다.
...
public class ClassMethodTest {
    public static void main(String[] args) {
        ...
        //// t.name, t.major, t.age 로 출력해도 보임
    }
}
