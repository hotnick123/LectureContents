...
class Market1 {
    private ArrayList<String> userBuyList; // 사용자의 구매목록
    private ArrayList<Integer> userBuyListStock; // 사용자의 구매물량

    private String[] marketSellList = {"선풍기", "키보드", "마우스", "모니터"}; // 판매목록
    private int[] marketSellListPrice = {380000, 80000, 70000, 400000}; // 판매가격

    private int myMoney; // 사용x

    private Boolean continueShopping; // 중재자 역할
    Scanner scan;
