...
import com.example.demo.service.VueQuiz89Service;
...
public class Quiz89Controller {

    @Autowired
    private VueQuiz89Service vueQuiz89Service;
    ...
    @GetMapping("/calcTriangleArea")
    @ResponseBody
    public ResponseEntity<Quiz89> getArea() {
        log.info("getRandom() request from vue");

        // 서버에서 제공해주는 랜덤 데이터
        Quiz89 area = vueQuiz89Service.getArea();
