...
public class VueMemberRepository {
    ...
    public  void create(NagetloningTest nagetloningTest) throws Exception{
        String query = "insert into vuemember (id, pw, address) values (?,?,?)";

        jdbcTemplate.update(query,nagetloningTest.getId(), nagetloningTest.getPw(), nagetloningTest.getAddress());
    }
