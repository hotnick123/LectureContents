...
import com.example.springTest.service.VueProductService;
...
public class VueProductController {
    ...
    public ResponseEntity<Product> readProduct(@PathVariable("productNo") Integer productNo) throws Exception {
    ...
    public ResponseEntity<Void> removeProduct(@PathVariable("productNo") Integer productNo) throws Exception {
