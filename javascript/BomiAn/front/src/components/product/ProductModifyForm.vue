    ...
    <div>
        ...
        <form @submit.prevent="onSubmit">
           ...
           <table>
            <tr>
                <td>상품번호</td>
                <td><input type="text" v-model="product.productNo" disabled></td>
            </tr>
            <tr>
                <td>등록일자</td>
                <td><input type="text" v-model="product.regDate" disabled></td>
            </tr>
            <tr>
                <td>상품명</td>
            ...
            <tr>
                <td>작성자</td>
                <td><input type="text" v-model="product.producer" disabled></td>
            </tr>
            <tr>
                <td>상품 세부사항</td>
