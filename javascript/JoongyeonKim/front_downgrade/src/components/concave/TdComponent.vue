...
export default {
    ...
    methods: {
        onClickTd () {
            ...
            let win = false  // let) var와 같은 효과를 가졌다 (줄쳐짐방지)
            ...
            if (
                ...
                this.tableData[this.cellIndex][0] === this.turn &&
                this.tableData[this.cellIndex][1] === this.turn &&
                this.tableData[this.cellIndex][2] === this.turn 
            ) {
                win = true
            } else if (
