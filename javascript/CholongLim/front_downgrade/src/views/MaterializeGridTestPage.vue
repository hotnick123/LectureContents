<template>
    <div class="container">
        ...
        <div class="row">
            ...
            <a class="btn-flat waves-effect waves-orange" @click="showMessage()">
                <i class="material-icons left">cloud</i>
                cloud
            </a>
            <a class="btn-flat waves-effect waves-yellow" @click="showMessage()">
                <i class="material-icons left">dehaze</i>
                MENU
            </a>
            <a class="btn-flat waves-effect waves-pink" @click="showMessage()">
                <i class="material-icons center">account_circle</i>
            </a>
            <a class="btn-floating waves-effect waves-green" @click="showMessage()">
                <i class="material-icons rifht">wifi</i>
                wifi
            </a>
        </div>
    </div>
